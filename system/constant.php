...
if($_SERVER['HTTP_HOST']=="localhost"){
      ...
      DEFINE ('DB_NAME', 'radioroot');//your local host db name
	}
	else{
		//live
		DEFINE ('DB_USER', '..........'); //your live db user
		DEFINE ('DB_PASSWORD', 'radio');//your live db password
		DEFINE ('DB_HOST', 'localhost');//your live db host
		DEFINE ('DB_NAME', 'oooooooooooooo');//your live db name
	}
